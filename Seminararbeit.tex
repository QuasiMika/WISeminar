...
\item
  ...
  2.1 \hyperref[datenanalyse-und-big-data]{Datenanalyse und Big Data}\\
...
Die Digitalisierung hat nahezu alle Bereiche des modernen Lebens
erfasst, und der Profisport bildet dabei keine Ausnahme. Fortschritte in
\textbf{Big Data, künstlicher Intelligenz (KI), Wearables und digitalen
Übertragungstechnologien} verändern grundlegend, wie Athleten
trainieren, Teams strategische Entscheidungen treffen und Fans
Sportereignisse erleben. Während früher die Einschätzung von
Trainer\emph{innen und subjektive Analysen dominierten, ermöglichen
heute datenbasierte Modelle eine präzisere Bewertung von Leistung,
Strategie und Gesundheitszustand der Sportler}innen. Diese
technologischen Fortschritte eröffnen nicht nur neue Möglichkeiten,
sondern werfen auch Fragen hinsichtlich \textbf{Fairness,
Kommerzialisierung und Ethik} im Profisport auf.
...
\subsection{Datenanalyse und Big Data}\label{datenanalyse-und-big-data}
